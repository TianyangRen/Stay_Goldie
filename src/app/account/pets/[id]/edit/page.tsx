    ...
    <section className="section-surface py-14">
      <div className="section-wrap">
        <div className="mx-auto max-w-lg">
          ...
          <Reveal delay={0.05}>
            <h1 className="mt-4 text-3xl font-semibold text-[var(--sg-green)]">Edit · {pet.name}</h1>
          </Reveal>
          <Reveal delay={0.08}>
            <p className="mt-2 text-sm text-zinc-600">Updates apply instantly on the booking page.</p>
          </Reveal>
          <div className="mt-8">
